...
import { OrderCardStyled } from "../styledComponents/div.styled";
import { anticipationKeyframes, goUp } from "./functions.anim";
...
export const AnimFoodCard = styled(OrderCardStyled)`
  animation: ${anticipationKeyframes()} 0.5s ease-in-out;
`;
